function ContactMap() {
    if (jQuery("#map_canvas").length > 0) {
        var e = "images/marker.png",
            ...
            t = 16,
            a = "Hello Friend!",
            s = "Here we are. Come to drink a coffee!",
            r = google.maps.MapTypeId.SATELLITE;
        "undefined" != typeof ClapatMapOptions && (e = ClapatMapOptions.map_marker_image, o = ClapatMapOptions.map_address, t = Number(ClapatMapOptions.map_zoom), a = ClapatMapOptions.marker_title, s = ClapatMapOptions.marker_text, r = 0 == ClapatMapOptions.map_type ? google.maps.MapTypeId.SATELLITE : google.maps.MapTypeId.ROADMAP);
        var i = {
                zoom: t,
            ...
            n = new google.maps.Map(document.getElementById("map_canvas"), i);
        google.maps.event.addDomListener(window, "resize", (function () {
            var e = n.getCenter();
            google.maps.event.trigger(n, "resize"),
            n.setCenter(e)
        }));
        var l = '<div id="content-map-marker" style="text-align:center; padding-top:10px; padding-left:10px"><div id="siteNotice"></div><h4 id="firstHeading" class="firstHeading" style="color:#000!important; font-weight:600; margin-bottom:0px;"><strong style="color:#000!important;">' + a + '</strong></h4><div id="bodyContent"><p color:#999; font-size:14px; margin-bottom:10px">' + s + "</p></div></div>",
            d = new google.maps.InfoWindow({content: l}),
            c = new google.maps.MarkerImage(e, new google.maps.Size(58, 63), new google.maps.Point(0, 0), new google.maps.Point(35, 20)),
            p = 43.270441,
            u = 6.640888;
        (new google.maps.Geocoder).geocode({
            ...
            if (o == google.maps.GeocoderStatus.OK) {
                ...
                p = e[0].geometry.location.lat(),
                u = e[0].geometry.location.lng();
                var t = new google.maps.LatLng(p, u),
...
function InitContactMap() {
    if (jQuery("#map_canvas").length > 0) 
        ...
        var e = "";
        "undefined" != typeof ClapatMapOptions && (e = "key=" + ClapatMapOptions.map_api_key);
        var o = document.createElement("script");
        o.type = "text/javascript",
        o.src = "https://maps.googleapis.com/maps/api/js?" + e + "&callback=ContactMap",
